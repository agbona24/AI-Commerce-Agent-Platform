...
export default function RegisterPage() {
  ...
  const canProceedStep2 = formData.fullName && formData.email && formData.password;
          ...
          >
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-3 rounded-full bg-gradient-to-r from-violet-600 via-primary to-cyan-500 text-white font-semibold flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed transition-all hover:opacity-90"
              >
                Continue
                <ArrowRight className="w-5 h-5" />
              </button>
